...
{	
	...
	function createXml()
	{
		try
		{
			...
			{
				throw new \Org\Util\SDKRuntimeException("缺少统一支付接口必填参数out_trade_no！"."<br>");
			}elseif($this->parameters["body"] == null){
				throw new \Org\Util\SDKRuntimeException("缺少统一支付接口必填参数body！"."<br>");
			}elseif ($this->parameters["total_fee"] == null ) {
				throw new \Org\Util\SDKRuntimeException("缺少统一支付接口必填参数total_fee！"."<br>");
			}elseif ($this->parameters["notify_url"] == null) {
				throw new \Org\Util\SDKRuntimeException("缺少统一支付接口必填参数notify_url！"."<br>");
			}elseif ($this->parameters["trade_type"] == null) {
				throw new \Org\Util\SDKRuntimeException("缺少统一支付接口必填参数trade_type！"."<br>");
			}
			elseif ($this->parameters["trade_type"] == "JSAPI" &&
				$this->parameters["openid"] == NULL){
				throw new \Org\Util\SDKRuntimeException("统一支付接口中，缺少必填参数openid！trade_type为JSAPI时，openid为必填参数！"."<br>");
			}
		   	$this->parameters["appid"] = WxPayConf_pub::APPID;//公众账号ID
		   	$this->parameters["mch_id"] = WxPayConf_pub::MCHID;//商户号
...
class WxPayConf_pub
{
	...
	const APPID = 'wxd07982249e620b62';
	//wx91961db8b6273777

	//受理商ID，身份标识
	const MCHID = '1448415902';
	//1317476101

	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = '21FD46CFE89364CDF878E713A7DD3923';
	//0F3D4E0CFC38DBB05819703183E89E92

	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = 'f712d4313050708b641c51ceefb80f83';
	//c1bbc0c0eb6975afbfcdd715efe4e5e6
	
	//=======【JSAPI路径设置】===================================
	//获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
	const JS_API_CALL_URL = 'http://yueche.siwoinfo.com/index.php?s=/addon/Forms/Wap/index/forms_id/12/publicid/1.html';
	...
	const NOTIFY_URL = 'http://yueche.siwoinfo.com/index.php/addon/Forms/Wap/notify_url/';
	const NOTIFY_NATIVE_URL = 'http://yueche.siwoinfo.com/index.php/Home/Jxyueche/notify_url/';
	//=======【curl超时设置】===================================
...
class JsApi_pub extends Common_util_pub
{
	...
	function createOauthUrlForCode($redirectUrl)
	{
		...
		$urlObj["redirect_uri"] = "http://yueche.siwoinfo.com/index.php?s=/addon/Forms/Wap/index/forms_id/12/publicid/1.html";
...
class Redpack_pub extends Wxpay_client_pub
{
	...
	{
		$urlObj["appid"] = WxPayConf_pub::APPID;
		$urlObj["redirect_uri"] = "http://yueche.siwoinfo.com/index.php?s=/addon/Forms/Wap/index/forms_id/10/publicid/1.html";
		$urlObj["response_type"] = "code";
		$urlObj["scope"] = "snsapi_base";
		$urlObj["state"] = "STATE"."#wechat_redirect";
		$bizString = $this->formatBizQueryParaMap($urlObj, false);
