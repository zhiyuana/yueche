...
<!--         <img style="height:49px;" src="/weiphp3.0/Public/Home/images/logo.png"> -->
    ...
    <script type="text/javascript" src="/Public/static/dingdan/js/select.js"></script>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="username" value="<?php echo ($user_detail['nickname']); ?>" disabled="disabled">
                <input type="hidden" name="uid" value="<?php echo ($user_detail['uid']); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">所属驾校：</label>
            <div class="controls">
                <input type="text" class="text input-large" id="jiaxiao" name="jiaxiao" value="<?php echo ($user_detail['jxname']); ?>" />
                <input type="hidden" name="jiaxiaoid" id="jiaxiaoid" value="<?php echo ($user_detail['jxid']); ?>">
        ...
        <div class="form-item">
            ...
            <!-- <input type="submit" value="确 定" class="btn submit-btn">  -->
			<button class="btn submit-btn ajax-post" id="submit" type="submit" target-form="form-horizontal">确 定</button>
