...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <!-- 数据列表 -->
		...
		<form action="<?php echo U('tui_Download',array('mdm'=>I('mdm'),'status'=>12));?>" method="post">
    ...
    <div class="data-table">
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody id="list">
              <?php if(is_array($tui_list)): $i = 0; $__LIST__ = $tui_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td ><?php echo ($vo["refund_id"]); ?></td>
                  <td ><?php echo ($vo["refund_fee"]); ?></td>
                  <td ><?php echo ($vo["taddtime"]); ?></td>
                  <td >已退款</td>
                  <td>
                    <a href="<?php echo U('tui_xq',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>">查看详情</a><!--  |
                    <a href="<?php echo U('dingdan_tuikuan_del',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>" class="del">删除</a> -->
                  </td>
...
// 	$.ajax({
// 		url:"<?php echo U('Dingdan/tui_list');?>",
// 		type:"POST",
// 		data:dataStr,
// 		dataType:"json",
...
// 					htmlstr += "<td>已退款</td>";
// 					htmlstr += "<td><a href='<?php echo U("tui_xq",array("id"=>"+n.id+","mdm"=>$_GET["mdm"]));?>' class='del'>查看详情</a></td></tr>";
// 				});
// 			}
// 			$("#list").html(htmlstr);
// 		}	
