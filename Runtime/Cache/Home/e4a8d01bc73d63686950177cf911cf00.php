...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
	...
	<!-- <form action="<?php echo U('Xueyuan/xueyuan_update',array('mdm'=>I('mdm'),'id'=>$list[0]['id']));?>" method="post" > -->
	     <!-- <input type="hidden" class="text input-large" name="id" value="<?php echo ($vo["id"]); ?>"> -->
     <li class="line" style="border-bottom: none;">  
        <div style="width:47%;float: left;margin-right: 60px;">
            <label style="line-height: 36px;">姓名：</label>               
            <!--<input type="text" class="text input-large" name="xname" value="<?php echo ($list[0]['xname']); ?>"
            style="border-radius: 5px;float: left;width: 344px;"><br>-->
             <span style="width: 344px;float: right;"><?php echo ($list[0]['xname']); ?></span>
        </div>
         <div style="width:47%;float: left;">
            <label  style="line-height: 36px;">手机号：  </label>              
            <!--<input type="text" class="text input-large" name="xphone" value="<?php echo ($list[0]['xphone']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
    ...
    <li class="line">
        <div style="width:47%;float: left;margin-right: 60px;">     	
            <label >性别： </label>              
            <!--<input type="radio" class="text input-large" name="xsex" value="1"
             <?php if($list[0]['xsex']==1): ?>checked='checked'<?php endif; ?>>&nbsp;男 &nbsp;
             <input type="radio" class="text input-large" name="xsex" value="2" <?php if($list[0]['xsex']==2): ?>checked='checked'<?php endif; ?>>&nbsp;女 -->
             <span style="width: 344px;float: right;"><?php if($list[0]['xsex']==1): ?>&nbsp;男 &nbsp;<?php else: ?>女<?php endif; ?></span>
        </div>
        <div style="width:47%;float: left;">
            <label  style="line-height: 36px;">身份证号：  </label>              
            <!--<input type="text" class="text input-large" name="xcard" value="<?php echo ($list[0]['xcard']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
             <span style="width: 344px;float: right;" id="card"><?php echo ($list[0]['xcard']); ?></span>
        </div>
    </li>
    <li class="line">  
        <div style="width:47%;margin-right:60px;float: left;">
            <label  style="line-height: 36px;">微信订单号：   </label>             
            <!--<input type="text" class="text input-large" name="transaction_id" value="<?php echo ($list[0]['transaction_id']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['transaction_id']); ?></span>
        </div>
        <div style="width:47%;float: left;">
            <label style="line-height: 36px;">商户订单号：  </label>             
            <!--<input type="text" class="text input-large" name="out_trade_no" value="<?php echo ($list[0]['out_trade_no']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['out_trade_no']); ?></span>
        </div>
    </li>
    <li class="line">      
         <div style="width:47%;margin-right: 60px;float: left;">
            <label  style="line-height: 36px;">预约车号：   </label>             
            <!--<input type="text" class="text input-large" name="pch" value="<?php echo ($list[0]['pch']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['pch']); ?></span>
         </div>
        <div style="width:47%;float: left;">
            <label  style="line-height: 36px;">预约日期：  </label>             
            <!--<input type="text" class="text input-large" name="pdata" value="<?php echo ($list[0]['pdata']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['pdata']); ?></span>
        </div>
    </li>
    <li class="line">    
         <div style="width:47%;margin-right: 60px;float: left;">
            <label  style="line-height: 36px;">预约时间段：   </label>             
            <!--<input type="text" class="text input-large" name="ptime" value="<?php echo ($list[0]['ptime']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['ptime']); ?></span>
         </div>
        <div style="width:47%;float: left;">
            <label  style="line-height: 36px;">下单时间：  </label>             
            <!--<input type="text" class="text input-large" name="daddtime" value="<?php echo ($list[0]['daddtime']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['daddtime']); ?></span>
        </div>
    </li>
    <li class="line">
         <div style="width:47%;margin-right: 60px;float: left;">
            <label  style="line-height: 36px;">缴费金额：   </label>             
            <!--<input type="text" class="text input-large" name="money" value="<?php echo ($list[0]['money']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['money']); ?></span>
         </div>
         <div style="width:47%;float: left;">
            <label  style="line-height: 36px;">组团人员：  </label>             
            <!--<input type="text" class="text input-large" name="daddtime" value="<?php echo ($list[0]['daddtime']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
    ...
    <li class="line">
         <div style="width:47%;margin-right: 60px;float: left;">
            <label  style="line-height: 36px;">教练姓名：   </label>             
            <!--<input type="text" class="text input-large" name="money" value="<?php echo ($list[0]['money']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['jname']); ?></span>
         </div>
         <div style="width:47%;float: left;">
            <label  style="line-height: 36px;">驾校名称：  </label>             
            <!--<input type="text" class="text input-large" name="daddtime" value="<?php echo ($list[0]['daddtime']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
        ...
        <div class="form-item form_bh">
            ...
            <!-- <a href="<?php echo U('Dayin/dayin_list');?>" class="btn">返回</a> -->
            <a href="javascript:history.back(-1)" class="btn">返回</a>
<!--             <script type="text/javascript">
                $('.btn').click(function(){
                    var card = $('#card').html();
                    $('.btn').attr("href","http://yueche.siwoinfo.com/index.php?s=/Home/Dayin/dayin_list/card/"+card); 
                })
            </script> -->
         </div>     
	     <!-- </form>	 -->
...
(function(){
  ...
  <script type="text/javascript" src="/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=<?php echo SITE_VERSION;?>" charset="UTF-7"></script> 
  <script type="text/javascript">
