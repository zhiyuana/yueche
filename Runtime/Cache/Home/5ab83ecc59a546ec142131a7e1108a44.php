...
<!--       <div class="data-table" style="margin-top:20px;">
        ...
        <a class="btn" href="<?php echo U('xueyuan_add',array('mdm'=>I('mdm')));?>">新 增</a>
        </div>  
        </div>
        </div> -->
    <div class="table-striped">
      <div style="padding-bottom: 5px;padding-left: 20px;">
          <input type="text" name="xy_name" id="xy_name" placeholder="请输入要查询学员的名字" value="<?php echo ($xy_name); ?>">
        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
              <?php if(is_array($xueyuan_list)): $i = 0; $__LIST__ = $xueyuan_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td type="headimgurl"><?php echo ($vo["id"]); ?></td>
                  <td type="content"><?php echo ($vo["xname"]); ?></td>
                  <td ><?php echo ($vo["xsex"]); ?></td>
				  <td ><?php echo ($vo["xphone"]); ?></td>
				  <td ><?php echo ($vo["xcard"]); ?></td>
				<td>
                    <a href="<?php echo U('xueyuan_edit',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>">编辑</a><!--  |
                    <a href="<?php echo U('xueyuan_del',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>" class="del">删除</a> -->
                  </td>
