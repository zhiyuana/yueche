      ...
      <div class="data-table" style="margin-top:20px;">
        ...
        <div class="table-striped">
            <div style="padding-bottom: 5px;padding-left: 20px;">
                <a class="btn" href="<?php echo U('jiaolian_add',array('mdm'=>I('mdm')));?>" style="margin-bottom: 10px;padding: 8px 15px;margin-left: -20px;">新 增</a>
                <a class="btn jl_chaxun" href="javascript:void(0)" style="margin-bottom: 10px;padding: 8px 15px;">查 询</a>
                <input type="text" name="jl_name" id="jl_name" placeholder="请输入要查询教练的名字" value="<?php echo ($jl_name); ?>">
            </div>  
        </div>
      </div>
        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
              <?php if(is_array($jiaolian_list)): $i = 0; $__LIST__ = $jiaolian_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td type="headimgurl"><?php echo ($vo["id"]); ?></td>
                    <td type="content"><?php echo ($vo["jname"]); ?></td>
                    <!-- <td ><?php echo ($vo["jsex"]); ?></td> -->
                    <td ><?php echo ($vo["jcard"]); ?></td>
                    <td ><?php echo ($vo["tbh"]); ?></td>
                    <!-- <td ><?php echo ($vo["jbh"]); ?></td> -->
                    <!-- <td ><?php echo ($vo["jl"]); ?></td> -->
      				      <td ><?php echo ($vo["jphone"]); ?></td>
      				      <td>
					            <a href="<?php echo U('jiaolian_look',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>">查看</a> |
                      <a href="<?php echo U('jiaolian_edit',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>">编辑</a> |
                      <a href="<?php echo U('jiaolian_del',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>" class="del">删除</a>
                  </td>
