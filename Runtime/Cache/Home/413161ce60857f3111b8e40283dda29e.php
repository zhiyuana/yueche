...
<?php
 $a = strrchr($_SERVER['DOCUMENT_ROOT'],'/'); $b = substr($a,1); if($_SESSION["$b"."_home"]['user_auth']['username'] == 'admin'){ ?>
...
<div class="admin_container">
    <section id="contents" class="tab-content">
      <div class="table-bar">
        <div class="main_data">
          <div class="left">
          <a class="data_item" href="javascript:void(0)">
              <span><?php echo (intval($count["today"])); ?></span><br/>今日新增用户
            </a>
            <a class="data_item" href="javascript:void(0)">
              <span><?php echo (intval($count["yestoday"])); ?></span><br/>昨日新增用户
        ...
        <?php if(!empty($notices)): ?><h6 class="main_h6">官网公告</h6>
        <div class="main_notice">
        <?php if(is_array($notices)): $i = 0; $__LIST__ = $notices;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nt): $mod = ($i % 2 );++$i;?><p><a href="#" target="_blank">◆ <?php echo ($nt["title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
        </div><?php endif; ?>
        <h6 class="main_h6">我的应用</h6>
      ...
      <div class="main_apps">
        <ul>
            <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li>
                  <div class="img">
                    <a href="javascript:void(0)"><img src="<?php echo ($data["app_icon"]); ?>"/></a>
                      
                    </div>
                  <div class="desc">
                          <p class="name"><?php echo ($data["title"]); ?></p>
                          <p class="intro"><?php echo ($data["description"]); ?></p>
                          <p><a class="use_btn" href="javascript:void(0)"><?php echo ($data["action"]); ?></a></p>
                    </div>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div>
      <div  class="mt_10"><center><a class="btn btn-large" href="javascript:void(0)">获取更多应用</a></center></div>
