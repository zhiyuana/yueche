...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
        <div class="sub" style="margin-top:-15px;background: #fff;">
            <form action='<?php echo U('paiban_add');?>' method='post' name="form">
                <div class="car">
                    <div class="car_date">
                        <label>日期：</label>
                    ...
                    <div class="car_all">
                        ...
                        <span style="margin:0px 0px 0px 250px;font-size:30px;color:blue;">学员排班发布</span>
                    </div>
                    <div style="padding-bottom: 20px;padding-left: 15px;float: right;margin-right: 20px">
                        <button class="btn add_info" href="">发布</button>
                    </div>
                </div>
                <div id="table_date">
