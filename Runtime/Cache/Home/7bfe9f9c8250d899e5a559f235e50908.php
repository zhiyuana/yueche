...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
	...
	<!-- <form action="<?php echo U('Xueyuan/xueyuan_update',array('mdm'=>I('mdm'),'id'=>$list[0]['id']));?>" method="post" > -->
     ...
     <li class="line" style="border-bottom: none;"> 
        <div style="width:48%;margin-right: 20px;float: left;">
            <label>退款编号：  </label>            
            <!--<input type="text" class="text input-large" name="id" value="<?php echo ($list[0]['id']); ?>" style="border-radius: 5px;background-color: #e5e5e5;
          cursor: not-allowed;float: left;width: 344px;" disabled="disabled"> -->
    ...
    <li class="line">   
         ...
         <!--<div style="width:48%;margin-right: 20px;float: left;">
            <label>年龄：</label>               
           <!-- <input type="text" class="text input-large" name="xage" value="<?php echo ($list[0]['xage']); ?>" style="border-radius: 5px;float: left;width: 344px;" > -->
    ...
    <li class="line">        	  
        ...
        <div style="width:48%;margin-right: 20px;float: left;">
            ...
            <span style="width: 344px;float: right;"><?php echo ($list[0]['transaction_id'] ? $list[0]['transaction_id'] : $list[0]['dbh']); ?></span>
        </div>
     </li>
    <li class="line">            
		 <div style="width:48%;margin-right: 20px;float: left;">
    ...
    <li class="line">                
        <div style="width:48%;margin-right: 20px;float: left;">
          ...
          <div style="width:48%;margin-right: 20px;float: left;">
            <label>退款说明：   </label>             
            <!--<input type="text" class="text input-large" name="shuoming" value="<?php echo ($list[0]['shuoming']); ?>" style="border-radius: 5px;float: left;width: 344px;">--> 
    ...
    <li class="line">                
        ...
        <div style="width:48%;margin-right: 20px;float: left;">
            <label>退款金额：  </label>             
            <!--<input type="text" class="text input-large" name="refund_fee" value="<?php echo ($list[0]['refund_fee']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
    ...
    <li class="line">
        <div style="width:48%;margin-right: 20px;float: left;">
         ...
         <div style="width:48%;margin-right: 20px;float: left;">
            <label>教练电话：  </label>             
            <!--<input type="text" class="text input-large" name="xmark" value="<?php echo ($list[0]['xmark']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
     ...
     <li class="line">
        <div style="width:48%;margin-right: 20px;float: left;">
            <label>备注：  </label>             
            <!--<input type="text" class="text input-large" name="xmark" value="<?php echo ($list[0]['xmark']); ?>" style="border-radius: 5px;float: left;width: 344px;" >--> 
             <span style="width: 344px;float: right;"><?php echo ($list[0]['xmark']); ?></span>
		</div>
     </li>      			 
        <div class="form-item form_bh">
            <!-- <input type="submit" class="btn" value="确定"> -->
            <a href="<?php echo U('dingdan/shen_list');?>" class="btn">返回</a>
         </div>     
	     <!-- </form>	 -->
            </div>
           </div>
