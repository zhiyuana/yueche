...
<div id="main-container" class="admin_container">
  ...
  <link rel="stylesheet" type="text/css" href="/Public/static/dingdan/css/bookstrap.css" />
...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <!-- 数据列表 -->
        ...
        <div style="padding-bottom: 20px;">
          <form action="<?php echo U('xiao_Download',array('mdm'=>I('mdm'),'status'=>2));?>" method="post">
    ...
    <div class="data-table">
        <div class="table-striped">
          <table cellspacing="1" class="table table-bordered">
            ...
            <!-- 列表 -->
            <tbody id="list">
              <?php if(is_array($xiao_list)): $i = 0; $__LIST__ = $xiao_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td >已消费</td>
                  <td>
                    <a href="<?php echo U('xiao_xq',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>">查看详情</a><!--  |
                    
                    <a href="<?php echo U('dingdan_del',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>" class="del">删除</a> -->
                    <a class="monrl" style="float: right;cursor: pointer;" name="<?php echo ($vo["id"]); ?>">修改订单状态</a>
                  </td>
...
<script type="text/javascript">
  $(".monrl").click(function(){
        ...
        $("#mod_btn").click(function(){
          ...
          $.ajax({
            url      :  "<?php echo U('Dingdan/mod_xiao');?>",
            type     :  "POST",
            dataType :  "text",
...
//  $.ajax({
//    url:"<?php echo U('Dingdan/xiao_list');?>",
//    type:"POST",
//    data:dataStr,
//    dataType:"json",
...
//          htmlstr += "<td>已消费</td>";
//          htmlstr += "<td><a href='<?php echo U("xiao_xq",array("id"=>"+n.id+","mdm"=>$_GET["mdm"]));?>' class='del'>查看详情</a></td></tr>";
//        });
//      }
//      $("#list").html(htmlstr);
