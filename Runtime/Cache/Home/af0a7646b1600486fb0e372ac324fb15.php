       ...
       <li class="line" style="border-bottom: none;">
          <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>编号：</label>
  			    <span style="width: 344px;float: right;"><?php echo ($vo["id"]); ?></span>           
          </div>
          <div style="width:47%;float: left;">
            <label><span class="need_flag">* </span>姓名：</label>
			      <span style="width: 344px;float: right;"><?php echo ($vo["jname"]); ?></span>
          </div>
      </li>
       <li class="line">
          <div style="width:47%;margin-right: 20px;float: left;">
              <label style="margin-right: 30px;"><span class="need_flag">* </span>性别： </label>
              <span style="width: 344px;float: right;"><?php if($list[0]['jsex']==1): ?>&nbsp;男 &nbsp;<?php else: ?>女<?php endif; ?></span>
          </div>
          <div style="width:47%;margin-right: 20px;float: left;">
              <label><span class="need_flag">* </span>手机号： </label>
              <span style="width: 344px;float: right;"><?php echo ($vo["jphone"]); ?></span> 
          </div>
      </li>
       <li class="line">
          <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>身份证号：  </label>
            <span style="width: 344px;float: right;"><?php echo ($vo["jcard"]); ?></span>
          </div>
         <!-- <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>驾驶证号 ：  </label> 
      <span style="width: 344px;float: right;"><?php echo ($vo["jbh"]); ?></span>
        </div> -->
        <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>教练证号：   </label>
            <span style="width: 344px;float: right;"><?php echo ($vo["tbh"]); ?></span> 
        </div>
      </li>
       <li class="line"> 
          <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>所属驾校：   </label>
            <span style="width: 344px;float: right;"><?php echo ($vo["jxname"]); ?></span> 
          </div>
        <div style="width:47%;margin-right: 20px;margin-left: 16px;float: left;">
            <label><span class="need_flag"> </span>备注：  </label>
            <span style="width: 344px;float: right;"><?php echo ($vo["jmark"]); ?></span>     
        </div>
      </li>
       <!-- <li class="line"> -->
         <!-- <div style="width:47%;margin-right: 20px;float: left;">
           <label> <span class="need_flag">* </span>驾龄： </label>
      <span style="width: 344px;float: right;"><?php echo ($vo["jl"]); ?></span>
        </div> -->
        <!-- <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>年龄：</label>               
            <span style="width: 344px;float: right;"><?php echo ($vo["jage"]); ?></span>
        </div> -->
         
      <!-- </li> --><?php endforeach; endif; else: echo "" ;endif; ?>					 
        <div class="form-item form_bh">
            <a href="<?php echo U('Jiaolian/jiaolian_list');?>" class="btn">返回</a>
         </div>     
