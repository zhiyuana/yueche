...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div style="padding-bottom: 20px;">
              ...
              <input type="text" value="<?php echo ($datetimepicker); ?>" id="datetimepicker" name="datetimepicker" placeholder="选择日期" style="width: 145px;margin-bottom: 0;"/>&nbsp;
    ...
    <div class="data-table">
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
              <?php if(is_array($mingxi_list)): $i = 0; $__LIST__ = $mingxi_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <!-- <td type="headimgurl"><?php echo ($vo["pdata"]); ?></td> -->
                  <td type="headimgurl"><?php echo ($vo["daddtime"]); ?></td>
                  <td type="content" style="position: relative">
                    <?php echo ($vo["xname"]); ?> 等<?php echo ($vo["tuan_num"]); ?>人
                  ...
                  <td type="content"><?php echo ($vo["money"]); ?></td>
                  <!-- <td type="content"><?php echo ($vo['money'] - $vo['money'] * $percent); ?></td> -->
                  <!-- <td type="content"><?php echo ($vo['money'] * $percent); ?></td> -->
                  <td type="content"><?php echo ($vo["money_shiji"]); ?></td>
                  <td type="content"><?php echo ($vo["money_shouxu"]); ?></td>
              </tr><?php endforeach; endif; else: echo "" ;endif; ?>
				        <tr>
                  <td type="headimgurl">合计</td>
                  <td align="" type="headimgurl"> </td>
                  <td align="" type="headimgurl"><?php echo ($sum_money); ?> 元</td>
                  <td align="" type="headimgurl"><?php echo ($sum_money_shiji); ?> 元</td>
                  <td align="" type="headimgurl"><?php echo ($sum_money_shouxu); ?> 元</td>
                </tr>
            </tbody>
