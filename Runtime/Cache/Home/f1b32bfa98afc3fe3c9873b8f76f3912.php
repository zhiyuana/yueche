...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div class="data-table" style="margin-top:20px;">
        ...
        <div style="padding-bottom: 20px;">
      		<form action="<?php echo U('shen_Download',array('mdm'=>I('mdm'),'status'=>3));?>" method="post">
            	<input id="data_riqi" type="hidden" value=""/>
                <input type="text" id="datetimepicker" name="datetimepicker" value="<?php echo ($datetimepicker); ?>" style="width: 145px;margin-bottom: 0;" placeholder="开始时间段搜索"/>&nbsp;-
            	<input id="data_riqi1" type="hidden" value=""/>
                <input type="text" id="datetimepicker1" name="datetimepicker1" value="<?php echo ($datetimepicker1); ?>" style="width: 145px;margin-bottom: 0;" placeholder="结束时间段搜索"/>
    			    <input type="text" name="keywords" value="<?php echo ($keywords); ?>" id="keywords" style="width: 235;margin: 0 10px;" placeholder="身份证号或手机号搜索">
      ...
      <div class="data-table">
          <div class="table-striped">
              <table cellspacing="1">
                ...
                <!-- 列表 -->
                <tbody id="list">
                  <?php if(is_array($shen_list)): $i = 0; $__LIST__ = $shen_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td >
                        ...
                        <input type="hidden" name="fs_type" id="fs_type" value="<?php echo ($vo["fs"]); ?>">
                        <a href="<?php echo U('shen_xq',array('id'=>$vo['id'],'mdm'=>$_GET['mdm']));?>">查看详情</a> |
...
<script type="text/javascript">
  ...
  $(".dayin").click(function(){
      ...
      if(id){
        $.ajax({
          url       : "<?php echo U('Dingdan/dayin_tuikuan');?>",
          type      : "POST",
          dataType  : "json",
          data      : {id:id},
          success   : function(result){
...
// 	$.ajax({
// 		url:"<?php echo U('Dingdan/shen_list');?>",
// 		type:"POST",
// 		data:dataStr,
// 		dataType:"json",
...
// 					htmlstr += "<td>退款中</td>";
// 					htmlstr += "<td ><input type='hidden' name='id' id='id' value='"+n.id+"'><a href='<?php echo U("shen_xq",array("id"=>"+n.id+","mdm"=>$_GET["mdm"]));?>'>查看详情</a> | <a onclick='tuikuan(this)' class='tuikuan' id='tuikuan' style='cursor: pointer;'>同意退款</a></td></tr>";
// 				});
// 			}
// 			$("#list").html(htmlstr);
// 		}	
