...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <!-- 数据列表 -->
        ...
        <input type="text" value="<?php echo ($data); ?>" id="datetimepicker9" style="width: 140px; margin-left: 20px;"/>
       ...
       <script type="text/javascript">
        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
                  <?php if(is_array($tongji_list)): $i = 0; $__LIST__ = $tongji_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($vo["data"]); ?></td>
                      <td><?php echo ($vo["ch"]); ?></td>
                      <td>
                          <!-- 预约的时间段标红色 -->
                          <?php if(is_array($vo['yuyue'])): $i = 0; $__LIST__ = $vo['yuyue'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$yy): $mod = ($i % 2 );++$i; if($yy): ?><span style="margin:3px 4px; background: red; border-radius: 5px; padding: 2px 4px;text-align: center;width:84px;display:block;float:left;"><?php echo ($yy); ?></span>
                            <else><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                          <!-- 没有预约的 -->
                          <?php if(is_array($vo['fabu'])): $i = 0; $__LIST__ = $vo['fabu'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><span style="margin:3px 4px; border:1px solid gray;    border-radius: 5px; padding: 2px 4px; text-align: center;width:84px;display:block;float:left;"><?php echo ($sub); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
                          
                      </td>
                      <!-- <td><?php echo ($vo["yuyueshijian"]); ?></td> -->
                      <td><?php echo ($vo["fbshichang"]); ?></td>
                      <td><?php echo ($vo["shichang"]); ?></td>
                      <td>
                        <a href="<?php echo U('tongji_xq',array('data'=>$vo[data],'ch'=>$vo[ch]));?>">查看详情</a>
                      </td>
