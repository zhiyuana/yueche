...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
	...
	<form action="<?php echo U('Xueyuan/xueyuan_update',array('mdm'=>I('mdm'),'id'=>$list[0]['id']));?>" method="post" >
	 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="hidden" class="text input-large" name="id" value="<?php echo ($vo["id"]); ?>">
       <div style="width:100%;">
         <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>编号：  </label>            
            <input type="text" class="text input-large" name="id" value="<?php echo ($vo["id"]); ?>" style="border-radius: 5px;background-color: #e5e5e5;
          cursor: not-allowed;float: right;width: 344px;" disabled="disabled"> 
        </div>
        <div style="width:47%;float: left;">
            <label><span class="need_flag">* </span>姓名：</label>               
            <input type="text" class="text input-large" name="xname" value="<?php echo ($vo["xname"]); ?>"
       ...
       <div style="width:100%;">
         ...
         <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>籍贯：</label>               
            <input type="text" class="text input-large" name="xaddr" value="<?php echo ($vo["xaddr"]); ?>" style="border-radius: 5px;float: right;width: 344px;" > 
        </div>
      </div>	  
       <div style="width:100%;">
		<div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>手机号： </label>               
            <input type="text" class="text input-large" name="xphone" value="<?php echo ($vo["xphone"]); ?>" style="border-radius: 5px;float: right;width: 344px;" > 
        </div>
        <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>身份证号：  </label>              
            <input type="text" class="text input-large" name="xcard" value="<?php echo ($vo["xcard"]); ?>" style="border-radius: 5px;float: right;width: 344px;"> 
        </div>
      </div>
       <div style="width:100%;">
<!--          <div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag">* </span>学员编号：   </label>             
            <input type="text" class="text input-large" name="xbh" value="<?php echo ($vo["xbh"]); ?>" style="border-radius: 5px;float: right;width: 344px;"> 
        </div> -->
		<div style="width:47%;margin-right: 20px;float: left;">
            <label><span class="need_flag"> </span>备注：  </label>             
            <input type="text" class="text input-large" name="xmark" value="<?php echo ($vo["xmark"]); ?>" style="border-radius: 5px;float: right;width: 344px;" > 
        </div>
      </div><?php endforeach; endif; else: echo "" ;endif; ?>					 
        <div class="form-item form_bh">
            <input type="submit" class="btn" value="确定">
            <a href="<?php echo U('Xueyuan/xueyuan_list');?>" class="btn">返回</a>
         </div>     
	     </form>	
            </div>
           </div>
