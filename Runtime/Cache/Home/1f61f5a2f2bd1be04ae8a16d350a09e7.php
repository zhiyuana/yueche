...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div class="data-table" style="margin-top:20px;">
        ...
        <a href="<?php echo U('Dayin/dayin_list');?>" style="margin:0 10px;color: #333;padding:6px 12px;background:#ddd;">学员预约</a>
        <a href="<?php echo U('Dayin/jxdayin_list');?>" style="margin:0 10px;color: #333;padding:6px 12px;">驾校预约</a>
		    	<label>学员身份证:</label>
		    	<input type="text" id="xcard" name="xcard" value="" style="margin-bottom: 0;"/>
		    </div>
<!-- 		    <div style="float:left;width: 30%;margin-right: 20px;">
		    	<label>教练身份证:</label>
		    	<input type="text" id="jcard" name="" value="" style="margin-bottom: 0;"/>
		    </div> -->
        <input type="submit" onclick="chaxun()"  value="搜 索" class="btn" >
    ...
    <div id="div_print" style="display:none"> 
      ...
      <p style="text-indent: 32.0000pt;text-align: left;line-height: 30px;letter-spacing:  2px;font-size: 16px;" class="MsoNormal" >甲方提供数字化考试车给乙方使用,为明确甲、乙双方的权利和义务,经双方协商,按照平等互利的自愿原则,就车辆、场地的使用相关事宜签订本协议</p>
        ...
        <p class="MsoNormal" style="text-align: left;margin-left:150px;display:inline-block;margin-top:20px;line-height: 30px;letter-spacing:  2px;font-size: 16px;"><span style="width: 200px;">乙方：教练员</span><br><span style="width: 200px;">乙方：学员</span></p>
    </div>
...
//                        if(xueyuan != undefined){
                            ...
                            //$('#xueyuan_name').append(xueyuan);
                            
//                        }
                        });
                      //var name_list = $('#xueyuan_name').html();
                      $('#pdata').append(item+item2);
                      var div_print = document.getElementById("div_print");
                      var status = printdiv(div_print);
                      // window.location.href = "http://yueche.siwoinfo.com/index.php?s=/Home/Dayin/dayin_list/";
                       $.ajax({
