    ...
    <!-- 数据列表 -->
        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
              <?php if(is_array($jiaxiao_xq)): $i = 0; $__LIST__ = $jiaxiao_xq;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
      ...
      <div class="form-item form_bh" style="border-top: 0px solid #ddd;">
          <a href="<?php echo U('Jiaxiao/jiaxiao_list');?>" class="btn">返回</a>
      </div>
    </section>
  </div>
