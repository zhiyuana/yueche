...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div class="data-table" style="margin-top:20px;">
        ...
        <div class="table-striped">
            <a class="btn" href="<?php echo U('jiaxiao_add',array('mdm'=>I('mdm')));?>" style="margin-bottom: 10px;padding: 8px 15px;margin-left: 0;">新 增</a>

            <a class="btn jx_chaxun" href="javascript:void(0)" style="margin-bottom: 10px;padding: 8px 15px;">查 询</a>
            <input type="text" name="jx_name" id="jx_name" placeholder="请输入要查询驾校的名字" value="<?php echo ($jx_name); ?>" style="width:240px;">  
        </div>
      </div>
        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
              <?php if(is_array($jiaxiao_list)): $i = 0; $__LIST__ = $jiaxiao_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td type="headimgurl"><?php echo ($vo["id"]); ?></td>
                  <td type="content"><?php echo ($vo["jxname"]); ?></td>
                  <td ><?php echo ($vo["jxfname"]); ?></td>
                  <td ><?php echo ($vo["jxphone"]); ?></td>
                  <td ><?php echo ($vo["num"]); ?></td>
      				    <td>
                    <a href="<?php echo U('jiaxiao_xq',array('id'=>$vo[id],'jxname'=>$vo[jxname],'mdm'=>$_GET['mdm']));?>">查看</a> |
                    <a href="<?php echo U('jiaxiao_edit',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>">编辑</a> <!-- |
                    <a href="<?php echo U('jiaxiao_del',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>" class="del">删除</a> -->
                  </td>
